...
int main() {
    ...
    const int materials[] = {
        DEDX_WATER_LIQUID, DEDX_SILICON, DEDX_LITHIUM_FLUORIDE, DEDX_GOLD, DEDX_COPPER, DEDX_LUCITE_PERSPEX_PMMA, -1};
            ...
            for (int k = 0; ions[k] != -1; k++) {
                ...
                if (no_of_samples != -1) {
                    ...
                    dedx_fill_default_energy_stp_table(
                        programs[i], ions[k], materials[j], default_energies, default_stps);
