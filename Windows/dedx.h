...
int dedx_load_compound_weigth(int prog, int ion, int *targets, float *weight, int length, int *err);
int dedx_load_config(int program, int ion, int target, int *use_bragg, int *err);
float dedx_get_stp(int id, float energy, int *err);
int dedx_load_compound(int prog, int ion, int *targets, int *compos, int length, int *err);
int dedx_load_bethe_config(int ion, int target, float pot, int *err);

void dedx_clean_up();

/* int dedx_ws_load_compound_weigth(dedx_workspace * ws, int prog, int ion, int * targets, float * weight, int length,
 * int * err); */
...
/* int dedx_ws_load_compound(dedx_workspace * ws, int prog, int ion, int * targets, int * compos, int length, int *
 * err); */
