...
int main(void) {
    ...
    failures += check_stp(DEDX_ICRU, DEDX_PROTON, DEDX_WATER, energy_grid[1], 2.574e2f);
    failures += check_stp(DEDX_ICRU, DEDX_PROTON, DEDX_WATER, energy_grid[2], 4.532e1f);
    failures += check_stp(DEDX_ICRU, DEDX_PROTON, DEDX_WATER, energy_grid[3], 8.746e0f);
    failures += check_stp(DEDX_ICRU, DEDX_PROTON, DEDX_WATER, energy_grid[4], 2.203e0f);
    ...
    failures += check_stp(DEDX_ICRU, DEDX_HELIUM, DEDX_WATER, energy_grid[1], 1.021e3f);
    failures += check_stp(DEDX_ICRU, DEDX_HELIUM, DEDX_WATER, energy_grid[2], 1.802e2f);
    failures += check_stp(DEDX_ICRU, DEDX_HELIUM, DEDX_WATER, energy_grid[3], 3.480e1f);
    ...
    failures += check_stp(DEDX_ICRU, DEDX_CARBON, DEDX_WATER, energy_grid[0], 5.589e3f);
    failures += check_stp(DEDX_ICRU, DEDX_CARBON, DEDX_WATER, energy_grid[1], 6.507e3f);
    failures += check_stp(DEDX_ICRU, DEDX_CARBON, DEDX_WATER, energy_grid[2], 1.607e3f);
    failures += check_stp(DEDX_ICRU, DEDX_CARBON, DEDX_WATER, energy_grid[3], 3.138e2f);
