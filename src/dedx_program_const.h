...
/* Per-program materials lists below are a coarse "generally usable with this program"
 * hint (elements the program's own tables lack are omitted; compounds are listed
 * unconditionally since Bragg additivity can serve any compound whose elements the
 * program covers). They are not ion-specific and don't account for per-compound
 * decomposition feasibility. For an exact, ion-specific, decomposition-aware answer,
 * use dedx_get_material_list_for_ion() (see dedx.h), which consults the embedded
 * target-id tables directly instead of a hand-maintained list. */
static const int dedx_program_available_materials[110][290] = {
  ...
  {1,2,4,6,7,8,10,13,14,18,22,26,29,32,36,42,47,50,54,64,74,78,79, // ASTAR (no Boron/Nickel/Zirconium/Tantalum: not in dedx_astar_target_ids)
   82,92,99,101,103,104,106,111,119,120,126,130,134,138,139,
  ...
  {1,2,4,6,7,8,10,13,14,18,22,26,29,32,36,42,47,50,54,64,74,78,79, // PSTAR (no Boron/Nickel/Zirconium/Tantalum: not in dedx_pstar_target_ids)
   82,92,99,101,103,104,106,111,119,120,126,130,134,138,139,
   141,155,160,169,179,185,189,191,197,200,201,202,203,204,209,213,215,216,219,
   221,222,223,225,226,227,232,238,245,252,255,263,264,266,276,277,906,-1},
  ...
  {1,2,4,5,6,7,8,10,13,14,18,22,26,28,29,32,36,40,42,47,50,54,64, // MSTAR
   ...
   141,155,160,169,179,185,189,191,197,200,201,202,203,204,209,213,215,216,219,
   221,222,223,225,226,227,232,238,245,252,255,263,264,266,276,277,906,-1},
  {1,2,4,6,7,8,10,13,14,18,22,26,28,29,32,36,42,47,50,54,74,78,79, // ICRU73_OLD (no Boron/Zirconium/Gadolinium/Tantalum: not in dedx_icru73_target_ids)
   82,92,99,101,103,104,106,111,119,120,126,130,134,138,139,
   141,155,160,169,179,185,189,191,197,200,201,202,203,204,209,213,215,216,219,
   221,222,223,225,226,227,232,238,245,252,255,263,264,266,276,277,906,-1},
  {1,2,4,6,7,8,10,13,14,18,22,26,28,29,32,36,42,47,50,54,74,78,79, // ICRU73 (union of dedx_icru73new_target_ids and dedx_icru73_target_ids; same exclusions as ICRU73_OLD)
   82,92,99,101,103,104,106,111,119,120,126,130,134,138,139,
   141,155,160,169,179,185,189,191,197,200,201,202,203,204,209,213,215,216,219,
   221,222,223,225,226,227,232,238,245,252,255,263,264,266,276,277,906,-1},
  {1,2,4,6,7,8,10,13,14,18,22,26,29,32,36,42,47,50,54,64,74,78,79, // ICRU49 (resolves to icru_pstar/icru_astar tables; no Boron/Nickel/Zirconium/Tantalum)
   82,92,99,101,103,104,106,111,119,120,126,130,134,138,139,
   141,155,160,169,179,185,189,191,197,200,201,202,203,204,209,213,215,216,219,
   221,222,223,225,226,227,232,238,245,252,255,263,264,266,276,277,906,-1},
  {-1}, // reserved internal slot
  {1,2,4,6,7,8,10,13,14,18,22,26,28,29,32,36,42,47,50,54,64,74,78,79, // ICRU (union of icru90_p/a/C, icru_pstar/astar, icru73(new+old); no Boron/Zirconium/Tantalum)
   82,92,99,101,103,104,106,111,119,120,126,130,134,138,139,
   141,155,160,169,179,185,189,191,197,200,201,202,203,204,209,213,215,216,219,
   221,222,223,225,226,227,232,238,245,252,255,263,264,266,276,277,906,-1}
};
