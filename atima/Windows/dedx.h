...
enum {DEDX_HYDROGEN=1, DEDX_HELIUM, DEDX_LITHIUM, DEDX_BERYLLIUM, DEDX_BORON,
      ...
      DEDX_TITANIUM, DEDX_VANADIUM, DEDX_CHROMIUM, DEDX_MANGANESE, DEDX_IRON,
      ...
      DEDX_GEL_IN_PHOTOGRAPHIC_EMULSION, DEDX_GLASS_LEAD, DEDX_GLASS_PLATE,
      DEDX_GLASS_PYREX, DEDX_GLUCOSE, DEDX_GLUTAMINE, DEDX_GLYCEROL,
